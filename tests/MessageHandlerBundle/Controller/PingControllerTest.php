...
/**
 * Functional Tests for PingRequests
 */
class PingControllerTest extends WebTestCase
{
     ...
     */
    public function testPingOnEmptyRequest()
    {
        $client = static::createClient();

        $crawler = $client->request('POST', '/pings');
     ...
     */
    public function testPingOnRequestWithAllTags()
    {
        $client = static::createClient();
...
END;
        ...
        $crawler = $client->request('POST', '/pings', array('xml' => $xml));
     ...
     */
    public function testPingOnRequestWithMissingTags()
    {
        $client = static::createClient();
...
END;
     ...
     */
    public function testPingOnRequestWithBadXMLStructure()
    {
        $client = static::createClient();
...
END;
     ...
     */
    public function testPingOnRequestWithInvalidType()
    {
        $client = static::createClient();
